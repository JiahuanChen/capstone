...
vect_dic = {"name":0,"location":1,"citation":2,"cpc":3,"inventor":4}
"""
import numpy
...
def vectorize(input_fname = "result.txt", array_tpye = "int8"):
    ...
    need_vect = [[],[],[],[],[]] #name location citation cpc inventor
    vect_dic = {"name":0,"location":1,"citation":2,"cpc":3,"inventor":4}
    ...
    vect = []
    words_in_bag = []
    vectorize_item = [vect_dic["location"],vect_dic["cpc"],vect_dic["inventor"]]
